...
const BreadcrumbTwo = ({ title, innertitle, team_details, career_details }) => {
  ...
  const { username } = useSelector((state) => state.user); // Obtener el valor del nombre de usuario desde el estado de Redux

  useTitleAnimation(subtitleRef);

  return (
    <>
      <div className="breadcrumb__area breadcrumb-height p-relative dark-bg">
