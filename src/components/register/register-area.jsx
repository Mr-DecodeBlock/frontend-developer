              ...
              <div className="signin-banner-from d-flex justify-content-center align-items-center">
                <div className="signin-banner-from-wrap">
                  <div className="signin-banner-title-box">
                    <h4 className="signin-banner-from-title text-center">{t('registerAccount')}</h4>
                  </div>
                  ...
                  <div className="signin-banner-from-box">
                    <h5 className="signin-banner-from-subtitle text-center">{t('registerWithEmail')}</h5> {/* Agregué la clase "text-center" para centrar horizontalmente */}
                    <RegisterForm />
                  </div>
                </div>
              </div>
