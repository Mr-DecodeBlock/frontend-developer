...
import sales_img_1 from "../../../public/assets/img/card/Referidos.png"
import sales_img_2 from "../../../public/assets/img/account/candado.png"
import sales_img_3 from "../../../public/assets/img/card/sale-3.png"


const sales_content = {
    title: <>¡Comparte la emoción y gana recompensa!</>,
    dub_title: <>¡Comparte la emoción y gana recompensa!</>,
    description: <>Ahora puedes maximizar tus ganancias al recomendar nuestra plataforma a tus seres queridos. Es una oportunidad única para ser recompensado mientras ellos también se benefician</>,
                  ...
                  <div className="row align-items-center">
                     <div className="col-xl-6 col-lg-6 order-1 order-md-1 wow tpfadeLeft" data-wow-duration=".9s" data-wow-delay=".5s">
                        <div className="tp-sales-section-box pb-20">
                           <h3 className="tp-section-title-3 pb-15 " style={{color: "orange"}}>{ style_service ?  dub_title : title}</h3>
