...
import hero_4_img_1  from "../../../../public/assets/img/card/cryptomonedas.png";
import hero_4_img_2  from "../../../../public/assets/img/hero/hero-4-2.png";
 
const hero_content = {
    sub_title: "Una wallet para todos",
    title: <>
    <span><span className='child'>Potencia tu</span></span>{" "}
    <span><span className='child'>capital</span></span>{" "}
    <span><span className='child'>e invierte</span></span>{" "}
    <span><span className='child'>con confianza </span></span>
    </>,
...
const HeroArea = () => {
   useCharAnimation('.tp-hero-title-4 span.child');
    ...
    return (
        <>
            <div className="tp-hero-area tp-hero-overlay dark-bg pt-200 pb-115 p-relative">
                  ...
                  <div className="row">
                     <div className="col-xl-7 col-lg-7">
                        <div className="tp-hero-4-section-box pt-10 z-index-3">
                           ...
                           <h3 className="tp-hero-title-4 pb-45 tp-char-animation">{title}</h3>

                           <Link className="tp-btn-green wow tpfadeUp" 
